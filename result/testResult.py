...
class TestResult:
    ...
    def get_html_report(self):
        with open("C:\\Users\\monitor\\PycharmProjects\\UIAuto\\result\\HTMLTestReport.html", 'w', encoding='utf-8') as f:
            runner = HTMLTestRunner(stream=f, title='testReport', description='generated by htmlTestReport', verbosity=3)
            runner.run(self.suite)

    def get_text_result(self):
        with open("C:\\Users\\monitor\\PycharmProjects\\UIAuto\\result\\textTestResult.txt", 'a', encoding='utf-8') as f:
